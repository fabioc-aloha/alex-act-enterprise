...
**Status in v1.1.2**: one canonical skill and one namespaced command, delivered
...
surface is stable under the Alex ACT semantic-versioning contract. Content
remains evidence-gated by Steward governance.
