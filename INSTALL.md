...
| --- | --- | --- |
| Core | `0.6.3` | `alex-act-core@alex-mall` |
| Illustrator | `0.6.3` | `alex-act-illustrator-plugin@alex-mall` |
| Enterprise | `0.1.3` | `alex-act-enterprise@alex-mall` |
| MSFT | `0.1.2` | Private direct install, tenant-gated |
